...
from models import User, Input, connect_to_mongodb
...
genai.configure(api_key="AIzaSyCZpM_5q6Ld5raoLPcRwoEEonR2lOeetlc")
app = Flask(__name__)
...
def get_gemini_response(input):
    model = genai.GenerativeModel('gemini-2.5-flash', system_instruction=sysprompt, safety_settings=None)
